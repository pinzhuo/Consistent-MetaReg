...
if __name__ == '__main__':
    ...
    #                                                                  '/data/liuyong/TianPinzhuo/IJCAI/reverse_office31_Euclidean_5way_trade5/epoch_30.pth.tar')
    ...
    for epoch in range(start_epoch, opt.num_epoch + 1):
        ...
        for i, batch in enumerate(tqdm(dloader_train)):
            ...
            if opt.cls_head == 'SVM':
                reverse_loss = cls_head.CMloss_Fnorm(emb_support, emb_query, labels_query, opt.train_way,
                                                     opt.train_query)
            else:
